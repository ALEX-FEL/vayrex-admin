        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="mt-0.5 text-sm text-muted-foreground">
              {format(ride.createdAt, "dd MMMM yyyy 'à' HH:mm", { locale: fr })}
            </p>
          </div>
        </div>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-sm font-medium">{ride.clientName}</p>
                    <p className="text-xs text-muted-foreground">{ride.clientPhone}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-sm font-medium">{ride.driverName ?? '—'}</p>
                    <p className="text-xs text-muted-foreground">{ride.driverPhone ?? '—'}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-sm font-medium">{ride.vehicleType}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
