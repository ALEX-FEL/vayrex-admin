...
import { ArrowLeft, Star, Car, FileText, CheckCircle, XCircle, PauseCircle } from 'lucide-react';
        ...
        <div className="grid gap-4 lg:grid-cols-3">
            ...
            <div className="rounded-xl border border-border bg-card p-5 shadow-sm">
              ...
              <div className="space-y-2.5">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className={`text-xs font-medium ${driver.isOnline ? 'text-emerald-600' : 'text-muted-foreground'}`}>
                    {driver.isOnline ? 'En ligne' : 'Hors ligne'}
                  </span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-muted-foreground">Inscrit le</span>
                  <span className="font-medium text-xs">{format(driver.createdAt, 'dd/MM/yyyy', { locale: fr })}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4 lg:col-span-2">
            ...
            <div className="rounded-xl border border-border bg-card p-5 shadow-sm">
              ...
              <div className="space-y-2.5">
                {[
                  { label: "Carte nationale d'identité", value: driver.idCardNumber },
                  { label: 'Permis de conduire', value: driver.licenseNumber },
                  { label: 'Carte grise', value: `CG-${driver.vehiclePlate.replace(/\s/g, '')}` },
                ].map(({ label, value }) => (
