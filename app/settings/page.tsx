  ...
  return (
    <DashboardLayout>
      <div className="space-y-5 max-w-2xl">
        ...
        {/* General */}
        <Section icon={Globe} title="Général">
          <div className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <select
                ...
                className="h-9 rounded-md border border-input bg-background px-3 text-sm max-w-xs w-full"
              >
          ...
          <div className="space-y-4">
            <div className="space-y-1.5">
              ...
              <p className="text-[11px] text-muted-foreground">
                Les sessions admin expireront après {settings.sessionDuration} minutes d'inactivité
              </p>
            </div>
            <Separator />
            <div className="flex items-center justify-between py-1">
        ...
        <div className="rounded-xl border border-border bg-card p-5 shadow-sm">
          ...
          <div className="space-y-2 text-xs">
            {[
              ...
              { label: 'Dernière mise à jour', value: '30 mai 2025' },
            ].map(({ label, value }) => (
