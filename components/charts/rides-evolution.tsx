...
interface RidesEvolutionChartProps {
  data: { month: string; courses: number; terminées: number; annulées: number }[];
}

export function RidesEvolutionChart({ data }: RidesEvolutionChartProps) {
  return (
